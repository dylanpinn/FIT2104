...
<nav class="w-full xl:w-auto xl:flex-initial p-4">
    <ul class="px-8 py-6 leading-relaxed bg-gray-400 rounded shadow">
        ...
        <li class="text-blue-700 hover:text-blue-500 font-bold tracking-wide"><?= $this->Form->postLink(
                __('Delete'),
...
<section class="w-full xl:w-auto xl:flex-1 xl:mt-4 py-0 px-4 container mx-auto">
    <h3 class="text-2xl font-bold relative tracking-wide text-gray-800 mb-2"><?= __('Edit Product') ?></h3>
    ...
    <div class="px-8 py-6 bg-gray-300 rounded shadow lg:max-w-4xl">
        ...
        <fieldset>
            ...
            echo $this->Form->control('country_of_origin', ["class" => "form-input"]);
            echo $this->Form->control('purchase_price', ["class" => "form-input"]);
            echo $this->Form->control('sale_price', ["class" => "form-input"]);
            echo $this->Form->control('description', ["class" => "form-input"]);
            echo $this->Form->control('category._ids', ['options' => $categories, "class" => "form-input"]);
            ?>
        </fieldset>
